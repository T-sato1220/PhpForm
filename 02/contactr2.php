...
<!--CSSファイルを切り替えと表示するためのプルダウンメニューを記述します。-->
    ...
    <div class="main">
            ...
            <form action="result2.php" method="post"><div class="bar">
        ...
        <select class=change name=linka onchange="changesytle('sample',value);">
            ...
            <dt><li>姓　　　　<font size="3" color="#ff0000">必須</font></li></dt><dd><input required type = "textbox" name="name1" pattern="^[a-zA-Z0-9ａ-ｚＡ-Ｚァ-ンぁ-ん一-龥]+$" pattern ="^(?!.*<\s).+$" size="20"></dd>
            <dt><li>名　　　　<font size="3" color="#ff0000">必須</font></li></dt><dd><input  required type = "textbox" name="name2" pattern="^[a-zA-Z0-9ａ-ｚＡ-Ｚァ-ンぁ-ん一-龥]+$" pattern ="^(?!.*<\s).+$" size="20"></dd>
    </div>
