...
<!--CSSファイルを切り替えと表示するためのプルダウンメニューを記述します。-->
    ...
    <body>
            ...
            <form action="result.php" method="post">
                <h2><dt><li>性　　　　<font size="3" color="#ff0000">必須</font></li></dt><dd><input required type = "textbox" name="name1" pattern="^[a-zA-Z0-9ａ-ｚＡ-Ｚぁ-ん一-龥]+$" pattern ="^(?!.*<\s).+$" size="20"></dd>
                <dt><li>名　　　　<font size="3" color="#ff0000">必須</font></li></dt><dd><input  required type = "textbox" name="name2" pattern="^[a-zA-Z0-9ａ-ｚＡ-Ｚぁ-ん一-龥]+$" pattern ="^(?!.*<\s).+$" size="20"><dd></h2>
　   <!--//性別-->
    ...
    <!--//住所-->
                <dt><li>住所　　　<font size="3" color="#ff0000">必須</font></li></dt><dd><input  required type = "textbox" name="address"  pattern="^[a-zA-Z0-9ａ-ｚＡ-Ｚぁ-ん一-龥]+$" pattern ="^(?!.*<\s).+$"  size="20"></dd>
    <!--//電話番号-->
